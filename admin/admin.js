...
function posts(){
 ...
 document.querySelectorAll('[data-edit]').forEach(b=>b.onclick=()=>editor(state.posts.find(p=>p.id===b.dataset.edit)));
}

function editor(p){
 const x=p||{title:'',slug:'',category:'تقنية',excerpt:'',content:'',image:'',author:'فريق التحرير',read_time:'5 دقائق',featured:false,status:'draft',seo_title:'',seo_description:''};
